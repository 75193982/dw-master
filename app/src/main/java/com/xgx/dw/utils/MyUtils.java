...
//        UUID deviceUuid = new UUID(androidId.hashCode(), ((long) imei.hashCode() << 32) | simSerialNumber.hashCode());
    ...
    public static void checkVersion(final Context mContext, final int i) {
        ...
        com.allenliu.versionchecklib.core.http.HttpHeaders httpHeaders = new com.allenliu.versionchecklib.core.http.HttpHeaders();
        httpHeaders.put(BaseApplication.token, "Bearer " + new Setting(mContext).loadString("token"));
